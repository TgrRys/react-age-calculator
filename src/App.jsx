...
const App = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-screen h-screen bg-gradient-to-br from-purple-500 to-pink-500">
      <div className="md:w-1/3 w-10/12">
        <h1 className="pb-3 text-white text-3xl text-center mb-3 font-sans font-semibold animate-fade-in-down">
          Age Calculator
        </h1>
        <p className="pb-2 text-white text-center mb-5 animate-fade-in-down">
          Calculate your age in years, months and days.
        </p>
        <div className="flex flex-col rounded-lg overflow-hidden bg-gradient-to-br from-purple-700 to-pink-600 px-6 py-8 w-full animate-slide-up">
          ...
          <h3 className="text-center lg:text-2xl md:text-lg text-base font-semibold text-white animate-fade-in-up">
